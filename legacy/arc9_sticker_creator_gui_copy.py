...
try:
    from PySide6.QtWidgets import (
        ...
        QStackedWidget, QFrame, QCheckBox, QProgressBar)
    from PySide6.QtGui import QPixmap, QFontDatabase, QFont, QMovie, QIcon, QColor, QPainter, QDesktopServices
    ...
    def run(self):
        try:
            ...
            for i, info in enumerate(self.processed_info):
                ...
                if core.process_image_to_vtf(self.output_dir, info, self.pack_name, info["compact_name"]):
...
class StickerCreatorGUI(QMainWindow):
    ...
    def create_setup_widget(self):
        ...
        self.img_folder_path = QLineEdit()
        self.img_folder_path.setPlaceholderText("Select a folder with your images...")
        ...
        self.out_folder_path = QLineEdit(OUTPUT_BASE_PATH)
    ...
    def on_creation_finished(self, pack_name):
        QMessageBox.information(self, "Success", f"Successfully created the '{pack_name}' sticker pack!\n\nThank you for using the tool! Meow! :3")
