...
def create_addon_structure(output_path, pack_name):
    ...
    os.makedirs(os.path.join(output_path, f"arc9_{pack_name}_stickers", "materials", "stickers", pack_name), exist_ok=True)
...
def process_image_to_vtf(output_path, image_info, pack_name, compact_name):
...
def create_lua_script(output_path, pack_name, processed_images):
    ...
    with open(lua_path, "a", encoding="utf-8") as f:
        if not file_existed:
            f.write("-- Generated by ARC9 Sticker Pack Maker++ by Midawek\n\n")
...
┗━ ╹ ╹╹┗╸┗━╸┗━┛ ━┛   ┗━┛ ╹ ╹┗━╸╹ ╹┗━╸╹┗╸   ╹  ╹ ╹┗━╸╹ ╹   ╹ ╹╹ ╹╹ ╹┗━╸╹┗╸ ╹  ╹ 
    ...
    for info in processed_info:
        ...
        if process_image_to_vtf(output_path, info, pack_name, info["compact_name"]):
