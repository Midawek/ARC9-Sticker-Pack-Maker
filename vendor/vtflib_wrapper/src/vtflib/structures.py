from ctypes import (
    Structure, c_char_p, c_uint32, c_bool, c_float, c_byte, c_uint
)
from .enums import (
    ImageFormat, MipmapFilter, SharpenFilter, ResizeMethod,
    KernelFilter, HeightConversionMethod, NormalAlphaResult
)
...
CreateOptions._fields_ = [
    ...
    ('StartFrame', c_uint32),
    ('BumpScale', c_float),
    ('ReflectivityX', c_float),
    ('ReflectivityY', c_float),
    ('ReflectivityZ', c_float),
    ('Mipmaps', c_byte),
